...
const ClickInput_module_scss_1 = __importDefault(require("./ClickInput.module.scss"));
const useInputValue_1 = require("../../../../hooks/useInputValue");
const Input_1 = __importDefault(require("../Input/Input"));
const ClickInput = (0, react_1.memo)((props) => {
    var _a;
    const inputName = (0, useInputValue_1.useInputValue)(props.value, props.validator);
    const [redactMod, setRedactMod] = (0, react_1.useState)(false);
    const [previousTimer, setPreviousTimer] = (0, react_1.useState)(Date.now());
    const [previousName, setPreviousName] = (0, react_1.useState)(props.value);
    ...
    return (<div className={ClickInput_module_scss_1.default.container} onClick={() => clickHandler()}>
            {redactMod ? <Input_1.default reff={inputRef} hook={inputName} className={[ClickInput_module_scss_1.default.input, (_a = props.className) !== null && _a !== void 0 ? _a : ''].flat().join(' ')}/> : <div>{previousName}</div>}
        </div>);
});
